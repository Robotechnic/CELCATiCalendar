...
const mainDialog = buildDialog(
	...
	"Sélectionner les dates de l'export que vous voulez faire.",
	exportData,
	{
		elementType: "form",
		role: "form",
...
function isConnected() {
	return Boolean(document.querySelector(".logInOrOut").innerText.match(/Déconnexion - [0-9]+/))
}
...
function getFederalId() {
	return document.querySelector(".logInOrOut").innerText.match(/Déconnexion - ([0-9]+)/)[1]
}
